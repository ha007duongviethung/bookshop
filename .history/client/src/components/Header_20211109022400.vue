        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li v-for="authorHeader in authorShow" :key="authorHeader"><a class="dropdown-item" href="#">{{authorHeader}}</a></li>
                <li><hr class="dropdown-divider" /></li>
                <li>
...
export default {
  ...
  async created() {
    this.token()
    this.authorShow = this.fetchAuthor()
    console.log(this.authorShow.PromiseResult)
  }
};
</script>
