          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <a class="dropdown-item" href="#">Công nghệ - kinh tế</a>
                </li>
                <li><a class="dropdown-item" href="#">Xã hội - lịch sử</a></li>
                <li>
                  <a class="dropdown-item" href="#">Hành động - phiêu lưu</a>
                </li>
                <li>
                  <a class="dropdown-item" href="#">Truyện tiểu thuyết</a>
                </li>
                <li>
                  <a class="dropdown-item" href="#">Phát triển bản thân</a>
                </li>
                <li><hr class="dropdown-divider" /></li>
                <li>
                  <a class="dropdown-item" href="#">Một số thể loại khác</a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="#">Tổng hợp Thành phố HCM</a></li>
                <li><hr class="dropdown-divider" /></li>
                <li>
