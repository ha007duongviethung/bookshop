          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <router-link class="dropdown-item" to="/type/economic-technology" :title="economic-technology">Công nghệ - kinh tế</router-link>
                </li>
                <li><router-link class="dropdown-item" to="/type">Xã hội - lịch sử</router-link></li>
                <li>
                  <router-link class="dropdown-item" to="/type">Hành động - phiêu lưu</router-link>
                </li>
                <li>
                  <router-link class="dropdown-item" to="/type">Truyện tiểu thuyết</router-link>
                </li>
                <li>
                  <router-link class="dropdown-item" to="/type">Phát triển bản thân</router-link>
                </li>
