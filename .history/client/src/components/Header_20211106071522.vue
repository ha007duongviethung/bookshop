          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <a class="dropdown-item" href="/type/economic-technology">Công nghệ - kinh tế</a>
                </li>
                <li><a class="dropdown-item" href="/type/historical-society">Xã hội - Lịch sử</a></li>
                <li>
                  <a class="dropdown-item" href="/type/action-adventure">Hành động - Phiêu lưu</a>
                </li>
                <li>
                  <a class="dropdown-item" href="/type/novel">Truyện tiểu thuyết</a>
                </li>
                <li>
                  <a class="dropdown-item" href="/type/self-growth">Phát triển bản thân</a>
                </li>
                <li><hr class="dropdown-divider" /></li>
                <li>
                  <a class="dropdown-item" href="/type">Một số thể loại khác</a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
