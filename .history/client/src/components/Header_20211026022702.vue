          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <router-link class="dropdown-item" to="/type/novel">Truyện tiểu thuyết</router-link>
                </li>
                <li>
                ...
                <li>
                  <router-link class="dropdown-item" to="/type/a">Một số thể loại khác</router-link>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><hr class="dropdown-divider" /></li>
                <li>
                  <a class="dropdown-item" href="#">Một số nhà xuất bản khác</a>
                </li>
              </ul>
            </li>
          </ul>
