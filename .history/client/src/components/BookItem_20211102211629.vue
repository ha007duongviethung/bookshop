    ...
    <tr>
        <td>
            <span class="custom-checkbox">
                <input type="checkbox" id="checkbox1" value="options[]">
        ...
        <div :id="`ed`+book._id" class="modal fade" @click="reset" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog large">
                <div class="modal-content">
                    <form @submit.prevent="handleUpdateBook" @click.stop>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pb_company" :value="book.pb_company" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="tp">Thể loại</label>
                                        <input type="text" class="form-control" id="tp" :value="book.type" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price" :value="book.price" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="amount">Số lượng</label>
                                        <input type="number" class="form-control" id="amount" :value="book.amount" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <label for="brief_des">Mô tả ngắn gọn</label>
                                <textarea class="form-control" id="brief_des" :value="book.brief_des"></textarea>
                            </div>
                            <div class="form-group mt-3">
                                <label for="detailed_des">Mô tả chi tiết</label>
                                <textarea class="form-control" id="detailed_des" :value="book.detailed_des"></textarea>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="height">Chiều dài (cm)</label>
                                        <input type="number" class="form-control" id="height" :value="book.height">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="width">Chiều rộng (cm)</label>
                                        <input type="number" class="form-control" id="width" :value="book.width">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="weight">Cân nặng (g)</label>
                                        <input type="number" class="form-control" id="weight" :value="book.weight">
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        async handleUpdateBook() {
            await BookAPI.updateBook(this.book._id, this.book)
        }
    }
}
</script>