                    ...
                    <ul class="navbar-nav my-2 my-lg-0 align-items-lg-center">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="left: unset; right: 0;">
                                <li>
                                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#FormLogin">Đăng nhập</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#FormRegister">Đăng ký</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
