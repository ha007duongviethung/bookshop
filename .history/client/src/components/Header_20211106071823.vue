          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <router-link class="dropdown-item" to="/economic-technology">Công nghệ - kinh tế</router-link>
                </li>
                <li><router-link class="dropdown-item" to="/historical-society">Xã hội - Lịch sử</router-link></li>
                <li>
                  <router-link class="dropdown-item" to="/action-adventure">Hành động - Phiêu lưu</router-link>
                </li>
                <li>
                  <router-link class="dropdown-item" to="/novel">Truyện tiểu thuyết</router-link>
                </li>
                <li>
                  <router-link class="dropdown-item" to="/self-growth">Phát triển bản thân</router-link>
                </li>
