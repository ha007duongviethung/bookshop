                    ...
                    <form @submit="handleAddBook" @click.stop>
                        ...
                        <div class="modal-body">					
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="book_name" :value="book.book_name" v-model="book_name" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pb_company" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="tp">Thể loại</label>
                                        <input type="text" class="form-control" id="tp" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea class="form-control" id="brief_des"></textarea>
                            </div>
                            <div class="form-group mt-3">
                                <label for="detailed_des">Mô tả chi tiết</label>
                                <textarea class="form-control" id="detailed_des"></textarea>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
