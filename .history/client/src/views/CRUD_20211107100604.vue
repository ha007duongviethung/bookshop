                ...
                <table class="table table-striped table-hover">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th><input type="text" v-model="search_name" @change="searchBookName" class="form-control searchable-input floatL" placeholder="Tìm kiếm tên sách"></th>
