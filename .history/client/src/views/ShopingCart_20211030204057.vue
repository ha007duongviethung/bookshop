    ...
    <div class="content">
        <div class="container px-4 py-5 mx-auto">
            ...
            <div class="row d-flex justify-content-center border-top py-3">
                <div class="col-6">
                    <div class="row d-flex flex-nowrap">
                        <div class="book"> <img src="https://images-na.ssl-images-amazon.com/images/I/41jf0Rju1fL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg" class="book-img"> </div>
                        <div class="my-auto flex-column d-flex pad-left">
                            <h6 class="mob-text">Thinking, Fast and Slow</h6>
                            <p class="mob-text">Daniel Kahneman</p>
                        </div>
            ...
            <div class="row d-flex justify-content-center border-top py-3">
                <div class="col-6">
                    <div class="row d-flex flex-nowrap">
                        <div class="book"> <img src="https://images-eu.ssl-images-amazon.com/images/I/51Pw6joFN7L._SY291_BO1,204,203,200_QL40_ML2_.jpg" class="book-img"> </div>
                        <div class="my-auto flex-column d-flex pad-left">
                            <h6 class="mob-text">Thinking, Fast and Slow</h6>
                            <p class="mob-text">Daniel Kahneman</p>
                        </div>
                    ...
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-2">
                                ...
                                </div> <button class="btn-block btn-blue"> <span> <span id="checkout" class="px-2">Checkout</span> <span id="check-amt">$26.48</span> </span> </button>
                            </div>
                        </div>
                    </div>
                </div>
