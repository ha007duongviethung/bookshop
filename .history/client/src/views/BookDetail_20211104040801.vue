                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pl-0">
                                        ...
                                        <button onclick="this.parentNode.querySelector('input[type=number]').stepDown()" @click="quantity = quantity == 1 ? 1 : quantity - 1"
                                            class="minus">-</button>
                                    ...
                                    <td class="pl-0 total">{{bookDetail.price * quantity}}</td>
                                </tr>
                            </tbody>
                            </table>
                        </div>
