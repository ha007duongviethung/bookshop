<template>
    <div class="content crud">
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="" data-bs-toggle="modal" @click="showModal = true" data-bs-target="#addEmployeeModal" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm sách</span></a>
        ...
        <div id="addEmployeeModal" class="modal fade" v-if="showModal" @click="reset" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog large">
                <div class="modal-content">
                    <form @submit.prevent="handleAddBook" @click.stop>
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" @click="showModal = false" class="btn btn-success" value="Thêm sách">
                        </div>
                    </form>
                </div>
            </div>
