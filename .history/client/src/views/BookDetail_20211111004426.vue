                ...
                <div class="row">
                    <div class="col-12">
                        <section class="px-3">
                            ...
                            <div class="row">
                                <div v-for="book in booksRelateTo" :key="book._id" class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                                    <div class="card mb-3">
                                    <router-link :to="`/book-detail_${book._id}`" class="card-img">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="quick-add_box">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="old-price">${{ book.price * 1.5}}</span>
                                                    </div>
                                                    <div class="mt-3">
                                                ...
                                                <button class="btn btn-success mx-auto w-100 view-detail" 
                                                    data-bs-dismiss="modal"
                                                    aria-label="Close">
                                                    <router-link :to="`/book-detail_${book._id}`">Xem chi tiết sách >></router-link>
                                                </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <router-link :to="`/book-detail_${book._id}`" class="card-title">{{ book.book_name }}</router-link>
                                        <p class="card-text">{{ sstring(book.type, 16) }}</p>
                                        <p class="card-text">
