...
export default {
  ...
  async created() {
    ...
    this.booksEconomicTechnology = await BookAPI.getBooksBySlug('economic_technology')
    this.booksSelfGrowth = await BookAPI.getBooksBySlug('self_growth')
    this.booksHistoricalSociety = await BookAPI.getBooksBySlug('historical_society')
  },
}
</script>