...
export default {
  ...
  methods: {
    ...
    indexPage(index) {
      if(this.amountItem < 12 && this.amountItem > 0) {
        this.lg = this.amountItem
      } else {
        this.lg = 12
      }
      if(this.currentPage < index - 1) {
        this.amountItem -= (12 * (index - 1 - this.currentPage) + this.lg)
      } else {
        this.amountItem += (12 * (this.currentPage - index - 1) + this.lg)
      }
      alert(this.amountItem)
