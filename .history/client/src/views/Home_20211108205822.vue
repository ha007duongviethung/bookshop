    ...
    <div class="home content">
      ...
      <div class="container">
        ...
        <div>
          ...
          <div class="row">
            <BookCard v-for="k in 6" :key="booksHorror[k-1]._id" :book="booksHorror[k-1]" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="row">
            <BookCard v-for="k in 6" :key="booksTop[k-1]._id" :book="booksTop[k-1]" />
          </div>
        </div>
...
export default {
  ...
  async created() {
    ...
    this.booksHorror = await BookAPI.getBooksBySlug('horror')
    this.booksTop = await BookAPI.getBooksBySlug('self_growth')
    const booksCombo = await BookAPI.getBooksCombo()

    let i = 0
    while(i < 6) {
      let j = Math.floor(Math.random() * (i+1))
      this.booksCombo.push(booksCombo[j])
      booksCombo.splice(j, 1)
      console.log("j: " + j + " combo: " + booksCombo + " data: " + this.booksCombo)
      i++
    }
