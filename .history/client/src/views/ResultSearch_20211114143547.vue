  ...
  <div>
    ...
    <div class="newbook content">
      ...
      <div class="container py-5">
        <div class="row alert alert-warning" role="alert" v-if="check == true">
          <div style="background-image: url(https://salt.tikicdn.com/desktop/img/icon-svg/icon-warning.svg); 
          content: ''; width: 16px; height: 17px; margin-right: 12px;"></div>
