...
export default class BookAPI {
    ...
    static async getBooksByType() {
        const booksNew = await axios.get(`${url}horror`)
        
        return booksNew.data.books
    }

    static async getBookTop() {
        let booksTop = await axios.get(`${url}self-growth`)
        
        return booksTop.data.books
    }
